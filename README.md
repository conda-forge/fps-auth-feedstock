...
Once the `conda-forge` channel has been enabled, `fps-auth` can be installed with:

```
conda install fps-auth
```

It is possible to list all of the versions of `fps-auth` available on your platform with:
